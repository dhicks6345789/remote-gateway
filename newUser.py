...
runAndLog(["ssh", "-i", "/var/www/id_rsa", "-o", "StrictHostKeyChecking=no", "administrator@192.168.1.112", "-t", "net user " + username + " " + password + " /ADD /Y"])
runAndLog(["ssh", "-i", "/var/www/id_rsa", "-o", "StrictHostKeyChecking=no", "administrator@192.168.1.112", "-t", "net localgroup \"Remote Desktop Users\" " + username + " /ADD"])
