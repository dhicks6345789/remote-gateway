...
INSTALL_TOTP="false"					# TOTP MFA extension (true/false)
INSTALL_DUO="false"					# DUO MFA extension (cant be installed simultaneously with TOTP, true/false)
INSTALL_LDAP="false"					# Active Directory extension (true/false)
INSTALL_NGINX="false"					# Install and configure Guacamole behind Nginx reverse proxy (http port 80 only, true/false)
